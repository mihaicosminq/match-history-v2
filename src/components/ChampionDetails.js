...
function ChampionDetails() {
    ...
    const imageUrl = isReady && champInfo?.skins?.map(skin => {
        return (
            <img
                src={"https://ddragon.leagueoflegends.com/cdn/img/champion/splash/" + champInfo.name.toString().replace(/ /g,"" ).replace(/'/,"") + "_" + skin.num + ".jpg"}/>
        )
    })
    ...
    return (
        <>
                    ...
                    {isReady && (
                        <>
                            <div
                                ...
                                className="champName">
                                <span
                                    className="nameStyle">{champInfo.name}</span>
                                <span
                                    className="nameStyle">{champInfo.title}</span>
                            </div>
                            <div
                                className="roleIcon">
                                ...
                                {champInfo.tags[0] === "Mage" ?
                                    <svg
                                        ...
                                        <path
                                            d="M84.48 77.3h13.41l-3.83-12.93h-9.58a36.73 36.73 0 00-27.54 12.45L50 85l-6.94-8.14a36.73 36.73 0 00-27.54-12.49H5.94L2.11 77.3h13.41a36.73 36.73 0 0127.54 12.45l.71.72h-9.1v7.42h30.9v-7.42h-9.1l.71-.72a35.85 35.85 0 0127.3-12.45"></path>
                                        <path
                                            d="M56.23 54.31L50 62.21l-6.23-7.9a5.42 5.42 0 01-.24-6.47L50 37.31l6.47 10.53a5.42 5.42 0 01-.24 6.47M42.58 28.93l-7.91 12.69a13.37 13.37 0 00.72 15.09L50 75.14l14.61-18.43a13 13 0 00.72-15.09L50 17l-.48.72a5.58 5.58 0 01-4.31 1.68c-4.07 0-7.18-8.62 4.55-17.24 0 0-28.74 5.5-14.85 30.41z"></path>
                                    </svg>
                                    :
                                        ...
                                        champInfo.tags[0] === "Support" ?
                                            ...
                                            champInfo.tags[0] === "Assassin" ?
                                                <svg
                                                    ...
                                                    className="style__StyledSpecsIcon-sc-8gkpub-17-c dnNsJq">
                                                    <path
                                                        d="M56.59 73.71l1.67-2.88c5.75-9.34 5.51-16 3.83-20.59a39.78 39.78 0 01-9.1 16 2 2 0 01-1.43.48H48.2a2.17 2.17 0 01-1.67-.72 39.78 39.78 0 01-9.1-16c-1.68 4.55-1.68 11.26 3.83 20.59l1.68 2.88-3.36 5.75 10.06 17.72L59.7 79.22z"></path>
                                                    <path
                                                ...
                                                champInfo.tags[0] === "Marksman" ?
                                                    <svg
                                                        ...
                                                        <path
                                                            d="M50 2.11l-7.66 21.31h.24L50 33.24l7.42-9.82h.24z"></path>
                                                    </svg>
                                                    :
                                                    champInfo.tags[0] === "Tank" ?
                                                        <svg
                                                            ...
                                                            className="style__StyledSpecsIcon-sc-8gkpub-17-c dnNsJq">
                                                            <path
                                                                d="M85.92 63.89L55 90V67.48h7.42v-9.1H37.55v9.1H45v22.75L14.08 63.89 8.33 21l27.54-10.51a39.13 39.13 0 0128.26 0L91.67 21zM66.28 5a47.61 47.61 0 00-32.56 0L2.11 17.19l6.7 49.57L41.86 95A13 13 0 0050 97.89 12.5 12.5 0 0058.14 95l33.05-28.24 6.7-49.57z"></path>
                                                            <path
                                                                d="M78.74 32.28L62 21.26v5.27H38v-5.27l-16.26 7.19a2.9 2.9 0 00-1.67 3.11l4.31 19.16a3.22 3.22 0 002.15 2.15l11.26 2.4V50h23.94v5.27l11.5-2.4a2.52 2.52 0 002.15-2.15l4.31-15.57a2.39 2.39 0 00-1-2.87M57.42 20.07H42.58L50 11.68z"></path>
                                                        </svg>
                                                        :
                                                        "Class not found"
                                }
                                    ...
                                    <div
                                        ...
                                        <div>
                                            <span>
                                                <img
                                                    width="14"
                                                    src="https://static.wikia.nocookie.net/leagueoflegends/images/8/8b/Mana_icon.png"/>
                                            </span>
                                            <span>Mana</span>
                                        </div>
                                        <div>
                                        ...
                                        <div
                                            ...
                                            <div>
                                                <span>
                                                    <img
                                                        width="14"
                                                        src="https://static.wikia.nocookie.net/leagueoflegends/images/3/31/Health_regeneration_icon.png/"/>
                                                </span>
                                                <span>HP Regen</span>
                                            </div>
                                            <div>{champInfo.stats.hpregen}</div>
                                        </div>
                                    </div>
                                    <div
                                        className="statSeparator">
                                        <div>
                                                <span>
                                                    <img
                                                        width="14"
                                                        src="https://static.wikia.nocookie.net/leagueoflegends/images/0/0c/Mana_regeneration_icon.png/"/>
                                                </span>
                                            <span>MP Regen</span>
                                            <div>{champInfo.stats.mpregen}</div>
                                        </div>
                                    </div>
                                </div>
                                <div
                                    ...
                                    <div
                                        ...
                                        <div>{champInfo.stats.attackdamage}</div>
                                    </div>
                                </div>
                                <div
                                    className="statsWrapper">
                                    <div
                                        ...
                                        <div>
                                            ...
                                            <div>{champInfo.stats.spellblock}</div>
                                        </div>
                                    </div>
                                    <div
                                        style={{textAlign: "center"}}>
                                                <span>
                                                    <img
                                                        width="14"
                                                        src="https://static.wikia.nocookie.net/leagueoflegends/images/e/ea/Movement_speed_icon.png"/>
                                                </span>
                                        <span>Movement Speed</span>
                                        <div>{champInfo.stats.movespeed}</div>
                                    </div>
                                </div>
            ...
            <section
                ...
                {isReady &&
                    <>
                        <h1 className="subTitle">Abilities</h1>
                        <div
                            className="skill">
                            <h6 className="passive">{champInfo.passive.name}</h6>
                            <div
                                style={{display: "flex"}}>
                                <div
                                    className="spellImage">
                                    <img
                                        src={"https://ddragon.leagueoflegends.com/cdn/13.7.1/img/passive/" + champInfo.passive.image.full}/>
                                </div>
                                <div>
                                  <span>
                ...
                {
                    isReady && champInfo.spells.map((champInfo) => {
                        return (
                            <>
                                <div
                                    key={champInfo.id}
                                    className="skill">
                                    <h6 className="passive">{champInfo.name}</h6>
                                    <div
                                        style={{display: "flex"}}>
                                        <div
                                            className="spellImage">
                                            <img
                                                src={"https://ddragon.leagueoflegends.com/cdn/13.7.1/img/spell/" + champInfo.image.full}/>
                                        </div>
                                        <div>
                                        <span>
            ...
            <section
                className="abilitySection">
                <h1 className="subTitle">Skins</h1>
                <div>
                {isReady && <Slideshow
                    slide={champInfo}
                    image={imageUrl}/>}
